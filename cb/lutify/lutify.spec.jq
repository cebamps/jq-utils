include "cb/lutify"; unicify
{ "a": [1,   "hi",   "world"], "b":   "hi", "c": true }
{ "a": [1, "1:hi", "1:world"], "b": "2:hi", "c": true }

include "cb/lutify"; map(string_leaves)
[  "hello",  "'world",  null ,  -1 , {"k":  true }, [ false ] ]
[ "'hello", "''world", "null", "-1", {"k": "true"}, ["false"] ]

include "cb/lutify"; map(destring_leaves)
[ "'hello", "''world", "null", "-1", {"k": "true"}, ["false"] ]
[  "hello",  "'world",  null ,  -1 , {"k":  true }, [ false ] ]
...
include "cb/lutify"; def shuf: .c = .b | .b |= [.[2][0],.[0]]; shuf, shuf == (lutify | (.[0] |= shuf) | delutify)
{"a":"hello","b":["world","hello",[42]]}
{"a":"hello","c":["world","hello",[42]],"b":[42,"world"]}
true

# intended use case: shuffle the first and substitute the last
include "cb/lutify"; lutify | .[0] |= reverse | .[2] = ["goodbye","mars"] | delutify
["hello","world"]
["mars","goodbye"]

include "cb/lutify"; lutify | .[0] |= {a:.b, b:.a} | .[2] = {a:"goodbye", b:"mars"} | delutify
{"a":"hello","b":"world"}
{"a":"mars","b":"goodbye"}
