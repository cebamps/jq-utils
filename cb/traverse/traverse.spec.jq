...
include "cb/traverse"; traverse_recur([0]; .[0] += [.[1]] | .[1] = .[0][0] | .[0][0] += 1)[]
{"a": "hello", "b": [[["world", "!"], false], null]}
[5,"hello","world","!",false,null]
{"a": 0, "b": [[[1, 2], 3], 4]}

include "cb/traverse"; traverse_stream([0]; .[0] += [.[1]] | .[1] = .[0][0] | .[0][0] += 1)[]
{"a": "hello", "b": [[["world", "!"], false], null]}
[5,"hello","world","!",false,null]
{"a": 0, "b": [[[1, 2], 3], 4]}
...
include "cb/traverse"; walkstate_recur(0; .[1] = {s:.[0], v:.[1]} | .[0] += 1)[]
[{"a":null,"b":false}]
4
