...
include "objects"; ins_before({new:9}; .value == 2) | .,keys_unsorted
{"a":1,"b":2,"c":3}
{"a":1,"new":9,"b":2,"c":3}
["a","new","b","c"]

include "objects"; ins_after({new:9}; .value == 2) | .,keys_unsorted
{"a":1,"b":2,"c":3}
{"a":1,"b":2,"new":9,"c":3}
["a","b","new","c"]

include "objects"; ins_before_key({new:9}; "b") | .,keys_unsorted
{"a":1,"b":2,"c":3}
{"a":1,"new":9,"b":2,"c":3}
["a","new","b","c"]

include "objects"; ins_after_key({new:9}; "b") | .,keys_unsorted
{"a":1,"b":2,"c":3}
{"a":1,"b":2,"new":9,"c":3}
["a","b","new","c"]

include "objects"; mv_before_key("r"; "b") | .,keys_unsorted
{"a":1,"b":2,"c":3,"r":9}
{"a":1,"r":9,"b":2,"c":3}
["a","r","b","c"]
...
include "objects"; mv_after_key("r"; "b") | .,keys_unsorted
{"a":1,"b":2,"c":3,"r":9}
{"a":1,"b":2,"r":9,"c":3}
["a","b","r","c"]
